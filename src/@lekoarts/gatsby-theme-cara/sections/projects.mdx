...
<ProjectCard
  title="Weather App"
  link="https://codepen.io/jdbain67/pen/dyzVmPz"
  bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
>
  A javascript weather app created as part of the FreeCodeCamp WebDev Curriculum  
</ProjectCard>
<ProjectCard
  title="Setting  up a yarn Workspace"
  link="https://www.lekoarts.de/javascript/setting-up-a-yarn-workspace-with-typescript-eshangelint-and-cypress?utm_source=cara&utm_medium=Theme"
